...
<body>
    ...
    <section>
        ...
        <h2>Mais sobre carros sedan:</h2>  
        <br><br>
        
            <main class="main-content">
                <img src="img/sedan-pesquisa.png" alt="Pesquisa sobre Sedan"> <br><br>

                <h3>O que é um carro sedan:</h3>

                <p>O que é um carro sedan? O carro sedan é aquele que possui uma carroceria dividida em três volumes: área do motor, espaço destinado ao motorista e aos passageiros e porta-malas. <b>É um modelo comprido, com espaço interno amplo e bagageiro mais volumoso</b>.</p>
