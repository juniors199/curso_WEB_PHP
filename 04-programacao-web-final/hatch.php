...
<body>
    ...
    <section>
        ...
        <h2>Mais sobre carros hatch:</h2>  
        <br><br>
        
            <main class="main-content">
                
                 <img src="img/hatch-pesquisa.png" alt="Pesquisa sobre Hatch"> 
                   
                <br><br>

                <h3>O que é um carro hatch:</h3>

                <p>O termo “hatch” tem origem na redução da palavra de língua inglesa “hatchback”, que significa traseira com comporta. Nesse sentido, se um carro é hatch, <b>ele apresenta em seu bagageiro uma porta, não uma tampa</b>. Pode parecer apenas um detalhe, mas é justamente esse fator que diferencia esse modelo.</p>
